...
class ConvolutionalNeuralNetwork:
    def __init__(self, max_features=2000, embed_dim=128):
        self.model_file = 'CNN_model_max_features_{}_embed_dim_{}'.format(max_features, embed_dim)
    ...
    def create_neural_network(self, input_length):
        ...
        model.add(Conv2D(64, kernel_size=3, activation='relu', input_shape=(self.max_features, 1)))
        model.add(Flatten())
